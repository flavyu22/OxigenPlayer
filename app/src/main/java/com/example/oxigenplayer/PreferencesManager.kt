...
class PreferencesManager(context: Context) {
    ...
    fun saveSubtitleVerticalOffset(offset: Float) {
        prefs.edit().putFloat("sub_vertical_offset", offset).apply()
    }
    fun getSubtitleVerticalOffset(): Float = prefs.getFloat("sub_vertical_offset", 20f) // Default 20dp offset
